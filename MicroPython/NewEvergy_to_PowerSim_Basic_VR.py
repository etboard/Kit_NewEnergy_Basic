# *****************************************************************************************
# FileName     : NewEnergy_to_PowerSim_Basic_VR
# Description  : 신재생에너지 코딩 키트, 가상 전력 변환(기본), 배율
# Author       : 손정인
...
# Modified     : 2025.01.06 : SCS : add VR
# *****************************************************************************************
...
vr_pin  = ADC(Pin(A0))                         # 풍력 발전량 측정 센서
...
def loop() :
    ...
    vr_value = vr_pin.read() - 1400
    if (vr_value != 0):
        vr_value = vr_value / 20
    solar_value = solar_value * vr_value
    print(solar_value, vr_value)
